...
if __name__ == '__main__':
    #evalBranchyLeNet('Results/LeNetBranch first/EvalResults')
    #evalBranchyLeNet('Results/LeNetBranch first no ground truth/EvalResults',GroundTruthAvailable=False)
    #evalBranchyAlexNet('Results/AlexNetBranch/EvalResults')
